...
MANAGEMENT_MODULE_TITLE = (
    "آموزش مدیریت"
)

GENERAL_EXAM_MODULE_ID = (
    "general_exam"
)

GENERAL_EXAM_MODULE_TITLE = (
    "آزمون عمومی"
)

GENERAL_EXAM_CHAPTER_ID = (
    "general"
)

GENERAL_EXAM_CHAPTER_TITLE = (
    "آزمون عمومی"
)

GENERAL_EXAM_LESSON_ID = (
    "general_quiz"
)

GENERAL_EXAM_LESSON_TITLE = (
    "آزمون عمومی"
)
...
def run_psychology_health_checks() -> bool:
    ...
    try:
        ...
        if not PSYCHOLOGY_MODULE_TITLE:
            ...
            logger.error(
                "Psychology MODULE_TITLE is empty."
            )

            return False

        chapters = (
            get_psychology_chapters()
        )
        ...
        if questions_count < 1:
            ...
            logger.error(
                "Psychology has no quiz questions."
            )
...
async def callback_user_registry(
    ...
    Runs in handler group 1 so it does not interfere
    with actual callback routing.
    """
...
def build_application() -> Application:
    ...
    Group 0:
        Commands and module callback routers.
    ...
    # IMPORTANT:
    #
    # Psychology now has ONE CENTRAL ROUTER:
    #
    # route_psychology_callback()
    #
    # This router handles:
    ...
    #
    # Therefore we do NOT register the individual
    # Psychology handlers separately here.
    # ======================================================
    ...
    # Banking callbacks
    #
    # Banking already contains its own central router.
    # ======================================================
    ...
    # IMPORTANT:
    #
    # This MUST remain after module-specific routers.
    # ======================================================
